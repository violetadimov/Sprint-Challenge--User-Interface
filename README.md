...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Semantic HTML is providing meaning to the content present in HTML documents through semantic HTML tags. these tags make it easier clearer for computers, search engines or other users that process this information.
...
4. Explain why git is valuable to a team of developers.
    ...
    Git is valuable to a team of developers because it enable communication among them while making changes to a project through commit messages of local repositories.

5. Define mobile-first design in your own words.

    It means when creating a website, we should develop smaller device screens first and work our way up to bigger screens.
